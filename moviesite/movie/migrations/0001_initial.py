# Generated by Django 5.1.4 on 2024-12-15 13:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('genre', models.CharField(max_length=30, unique=True, verbose_name=movie.models.Genre)),
                ('types', models.CharField(choices=[('144p', '144p'), ('360p', '360p'), ('480p', '480p'), ('720p', '720p'), ('1080p', '1080p')], max_length=30)),
                ('movie_time', models.PositiveSmallIntegerField()),
                ('description', models.TextField()),
                ('movie_trailer', models.FileField(upload_to='')),
                ('movie_image', models.ImageField(upload_to='movie_images')),
                ('status_movie', models.CharField(choices=[('pro', 'pro'), ('simple', 'simple')], default='simple', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movie.movie')),
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movie.rating')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
    ]
